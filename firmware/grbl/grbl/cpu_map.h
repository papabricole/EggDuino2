...
#define cpu_map_h
  ...
  #define Y_LIMIT_BIT      0  // Uno Digital Pin 10
  ...
  #define CONTROL_RESET_BIT         2  // Uno Analog Pin 0
  #define CONTROL_FEED_HOLD_BIT     1  // Uno Analog Pin 1
  #define CONTROL_CYCLE_START_BIT   0  // Uno Analog Pin 2
  #define CONTROL_SAFETY_DOOR_BIT   0  // Uno Analog Pin 1 NOTE: Safety door is shared with feed hold. Enabled by config define.
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
      ...
      #else
        #define SPINDLE_ENABLE_BIT    A5  // Uno Digital Pin 11
      #endif
    #else
